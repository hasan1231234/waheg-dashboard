                        ...
                        <div className="box-home">
                            ...
                            <div className="d-flex align-items-center gap-5">
                                <div>
                                    ...
                                    <p className='fw-bold fs-3 p-0 m-0'>500</p>
                                </div>
                                <div>
                                    <p className='text-secondary p-0 m-0'>عدد المعلمين الخاص</p>
                                    <p className='fw-bold fs-3 p-0 m-0'>100</p>
                                </div>
                            </div>
                        </div>
                        <div className="box-home">
                    ...
                    <div className="box-students my-5">
                        ...
                        <ul className="m-0 p-0">
                            <li className='d-flex align-items-center justify-content-between'>
                                ...
                                <span className='fw-bold'>ترتيب الفيديو</span>
                                <span className='fw-bold'>الفيديو</span>
                                <span className='fw-bold'>PDF</span>
                                <span className='fw-bold'>الكورس</span>
                                <span className='fw-bold'>الفصل</span>
                                <span className='fw-bold'>التنزيل</span>
                                <span className='fw-bold'>الحالة</span>
                                <span className='fw-bold'>مسموح للعرض للجميع</span>
                            ...
                            <li className='d-flex mb-3 align-items-center justify-content-between'>
                                ...
                                <span className='text-secondary'>المقدمة</span>
                                <span className='text-secondary'>1</span>
                                <span className='text-success'>مشاهدة</span>
                                <span className='text-secondary'>-</span>
                                <span className='text-secondary'>القدرات</span>
                                <span className='text-secondary'>كمي</span>
                                <span className='text-secondary'>غير مسموح</span>

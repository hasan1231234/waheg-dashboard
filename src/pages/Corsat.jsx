            ...
            <div className="d-flex gap-3">
                ...
                <div className="rigth-section my-5 w-100 px-5">
                    ...
                    <div className='d-flex justify-content-between align-items-center '>
                        ...
                        <div className="box-home box-corsat">
                    ...
                    <div className="box-students my-5">
                        ...
                        <ul className="m-0 p-0">
                            <li className='d-flex align-items-center justify-content-between'>
                                ...
                                <span className='fw-bold'>المرحلة التعليمية</span>
                            ...
                            <li className='d-flex mb-3 align-items-center justify-content-between'>
                                <span className='text-secondary'>الكيمياء</span>
                                <span className='text-secondary'>الكيمياء</span>
                                <span className='text-secondary'>طلاب الجامعة</span>
